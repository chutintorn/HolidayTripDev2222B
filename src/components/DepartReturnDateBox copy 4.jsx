...
export default function DepartReturnDateBox({
  ...
  // ✅ Stronger date value (same intensity as airport text)
  const valueClass =
    "text-[14px] sm:text-[15px] text-slate-900 font-semibold leading-tight truncate";
      ...
      <div className="relative">
        <div className={gridClass}>
          ...
          >
            ...
            {/* ✅ Remove 'Select/เลือกวัน' placeholder completely */}
